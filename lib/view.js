...
View.prototype.lookup = function (name, options) {
    ...
    // looking in the root bundle first because that's the way to
    // override any dependency specific template and also because
    ...
    // looking in a more specific bundle
...
View.prototype.render = function (options, fn) {
    ...
    if (layout) {
        ...
        options = utils.extend({}, options, { outlet: template(options) });
        template = layout;
    }
